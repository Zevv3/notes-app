...
export function NoteList({ availableTags, notes, onUpdateTag, onDeleteTag }: NoteListProps) {
    ...
    const filteredNotes = useMemo(() => {
        return notes.filter(note => {
            ...
            // loop through selected tags, make sure every single one of them returns true
            // when checking if the note contains the tag we are looping through
            // - making sure all of the tags match, not just one
...
function EditTagsModal({ availableTags, handleClose,
    show, onDeleteTag, onUpdateTag }: EditTagsModalProps) {
    return (
